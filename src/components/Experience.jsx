  ...
  render() {
    return (
      <div className="border-b border-neutral-400 pb-4">
        <motion.h2 initial={{opacity:0,y:-100}} whileInView={{opacity:1, y:0}} transition={{delay:0.2,duration:0.8}} className="my-20 text-center text-4xl">Experience</motion.h2>
        <div>
